...
public class Activity_Alfajores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alfajores);
        ...
        ib3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Alfajores.this, Activity_Inicio.class);
        ...
        ib4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Alfajores.this, Activity_Pedido.class);
                Bundle bundle = new Bundle();
                bundle.putString("rut", Rut);
                intent.putExtras(bundle);
                startActivity(intent);
...
// Obtén una referencia al LinearLayout
        ...
        LinearLayout linearContainer = new LinearLayout(Activity_Alfajores.this);
        ...
        Typeface typeface = ResourcesCompat.getFont(Activity_Alfajores.this, R.font.description);
        TextView precioFinalTextView = new TextView(Activity_Alfajores.this);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            LinearLayout orderContainer = new LinearLayout(Activity_Alfajores.this);
                            ...
                            for (int i = 0; i < response.length(); i++) {
                               ...
                               final String Alfajor_id = orderObject.getString("id");
                                ...
                                LinearLayout textButtonLayout = new LinearLayout(Activity_Alfajores.this);
                                textButtonLayout.setOrientation(LinearLayout.VERTICAL);
                                textButtonLayout.setGravity(Gravity.CENTER_HORIZONTAL);


                                LinearLayout orderLayout = new LinearLayout(Activity_Alfajores.this);
                                ...
                                ImageView imageView = new ImageView(Activity_Alfajores.this);
                                ...
                                Space space1 = new Space(Activity_Alfajores.this);
                                ...
                                // Crea  boton Añadir
                                Button VerButton = new Button(Activity_Alfajores.this);
                                ...
                                VerButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    createUser(Double.valueOf(precio),fechaActual,1,Double.valueOf(precio),Rut,Integer.parseInt(Alfajor_id),1,img);
                                            cantidadPendientes++;
                                ...
                                Space space3 = new Space(Activity_Alfajores.this);
                                ...
                                Space space2 = new Space(Activity_Alfajores.this);
                                ...
                                Typeface typeface = ResourcesCompat.getFont(Activity_Alfajores.this, R.font.description);
                                TextView textView = new TextView(Activity_Alfajores.this);
    ...
    private void createUser(final Double Precio, final String Fecha, final int Cantidad, final Double PrecioFinal, final String usuario_rut, final int alfajor_id, final int estadoorden_id,final String img) {
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(Activity_Alfajores.this , "Añadido", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("pan_id","0");
                params.put("alfajor_id",String.valueOf(alfajor_id));
